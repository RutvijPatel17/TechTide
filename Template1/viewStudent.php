...
<body class="py-5 md:py-0 bg-black/[0.15] dark:bg-transparent">
                                        ...
                                        <tbody>
                                            ...
                                            ?>
                                                <tr>
                                                    ...
                                                    <td>
                                                        <button type="submit" class="btn btn-primary w-100" name=btnsubmit onclick="handleEdit(<?php echo $row['Student_id']; ?>)">Edit</button>
                                                        <button type="submit" class="btn btn-primary w-100" name=btnsubmit onclick="handleDelete(<?php echo $row['Student_id']; ?>)">Delete</button>
                                                    </td>
                                                </tr>
                                            <?php
                                            }
    ...
    <script>
        function handleDelete(id){
            ...
            window.location.href="deleteStudent.php?Student_id=" +id;
        }
    </script>
    <script>
