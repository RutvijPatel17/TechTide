...
<head>
  ...
  />
    ...
    * { margin:0; padding:0; box-sizing:border-box; }
    ...
    .vm-section h2 { margin-bottom:1.5rem; font-size:2rem; color:#333; }
    .vm-section p {
      font-size:1.1rem;
      color:#555;
      max-width:800px;
    ...
    @media (max-width:768px){
      .vm-section h2 { font-size:1.5rem; }
      .vm-section p { font-size:1rem; }
    }
  </style>
    <!-- END: CSS Assets-->
</head>
...
<body class="py-5 md:py-0 bg-black/[0.15] dark:bg-transparent">
            ...
            <div class="top-bar -mx-4 px-4 md:mx-0 md:px-0">
                ...
                <nav aria-label="breadcrumb" class="-intro-x mr-auto hidden sm:flex">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">About College</li>
                    </ol>
                </nav>
                <!-- END: Breadcrumb -->
                <!-- BEGIN: Search -->
  ...
  <section class="vm-section">
    <h2>Vision</h2>
    <p>
      “To develop, train and nurture intellectually capable, innovative and entrepreneurial professionals to contribute to the growth of science and technology through education, research, global consultancy and industry‑academia collaboration.”
    </p><br><br>
    <h2>Mission</h2>
    <p>
      “To evolve into centre of excellence by providing value based technical education, transformative research and innovations for creating a sustainable and advanced society.”
    </p>
  </section>
