<?php
    ...
    $result = mysqli_query($conn, "select * from tbl_student where Student_id= ".$Student_id) or die(mysqli_error($conn));
    ...
    if (isset($_POST["btnsubmit"])){
        ...
        $result = mysqli_query($conn,"UPDATE tbl_student SET Name='$stdname',Email='$email',phone='$phone',College='$college' WHERE Student_id='$Student_id';") or die (mysqli_error($conn));
        //echo $result;die;
        if($result){
        echo "<script>
                            ...
                            <div id="input" class="p-5">
                                <div class="preview">
                                    <div class="mt-3">
                                        ...
                                        <input id="regular-form-2" type="text" class="form-control form-control-rounded" placeholder="Enter Name" name="stdname" value="<?php echo $name_value;?>"><br><br>
                                        <label for="regular-form-2" class="form-label">Email</label>
                                        <input id="regular-form-2" type="email" class="form-control form-control-rounded" placeholder="Enter Email" name="email" value="<?php echo $email_value;?>"><br><br>
                                        <label for="regular-form-2" class="form-label">Phone</label>
                                        <input id="regular-form-2" type="text" class="form-control form-control-rounded" placeholder="Enter Phone" name="phone" value="<?php echo $phone_value;?>"><br><br>
                                        <label for="regular-form-2" class="form-label">College</label>
                                        <input id="regular-form-2" type="text" class="form-control form-control-rounded" placeholder="Enter College" name="college" value="<?php echo $college_value;?>"><br><br>
