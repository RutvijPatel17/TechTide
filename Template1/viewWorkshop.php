...
<body class="py-5 md:py-0 bg-black/[0.15] dark:bg-transparent">
                                   ...
                                   <table class="table" style="min-width: 1000px;">
                                        ...
                                        <thead>
                                            <tr>
                                                ...
                                                <th class="whitespace-nowrap" style="width:800px">Operation</th>
                                            </tr>
                                        </thead>
                                        <tbody>
                                            <?php
                                            ...
                                            ?>
                                                <tr>
                                                    ...
                                                    <td >
                                                        <button type="submit" class="btn btn-primary" name=btnsubmit onclick="handleEdit(<?php echo $row['Workshop_ID']; ?>)">Edit</button>                                  
                                                        <button type="submit" class="btn btn-primary" name=btnsubmit onclick="handleDelete(<?php echo $row['Workshop_ID']; ?>)">Delete</button>                                     
                                                    </td>
                                                </tr>
                                            <?php
                                            }
    ...
    <script>
        function handleDelete(id){
            ...
            window.location.href="deleteWorkshop.php?Workshop_ID=" +id;
        }
    </script>
    <script>
        function handleEdit(id){
            
            window.location.href="editWorkshop.php?Workshop_ID=" +id;
        }
    </script>
