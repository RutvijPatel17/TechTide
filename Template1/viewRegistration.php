...
<body class="py-5 md:py-0 bg-black/[0.15] dark:bg-transparent">
                                        ...
                                        <tbody>
                                            ...
                                            ?>
                                                <tr>
                                                    ...
                                                    <td>
                                                        <button type="submit" class="btn btn-primary w-100" name=btnsubmit onclick="handleEdit(<?php echo $row['Registration_ID']; ?>)">Edit</button>
                                                        <button type="submit" class="btn btn-primary w-100" name=btnsubmit onclick="handleDelete(<?php echo $row['Registration_ID']; ?>)">Delete</button>
                                                    </td>
                                                </tr>
                                            <?php
                                            }
    ...
    <script>
        function handleDelete(id){
            ...
            window.location.href="deleteRegistration.php?Registration_ID=" +id;
        }
    </script>
        <script>
        function handleEdit(id){
            
            window.location.href="editRegistration.php?Registration_ID=" +id;
        }
    </script>
