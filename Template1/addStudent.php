<?php
    ...
    if (isset($_POST["btnsubmit"])){
        ...
        $result = mysqli_query($conn,"insert into tbl_student(Name,Email,Phone,College) 
        values('$stdname','$email','$phone','$college')") or die (mysqli_error($conn));
        //echo $result;die;
        if($result){
        echo "<script>
                            ...
                            <div id="input" class="p-5">
                                <div class="preview">
                                    <div class="mt-3">
                                        ...
                                        <input id="regular-form-2" type="text" class="form-control form-control-rounded" placeholder="Enter Name" name="stdname"><br><br>
                                        <label for="regular-form-2" class="form-label">Email</label>
                                        <input id="regular-form-2" type="email" class="form-control form-control-rounded" placeholder="Enter Email" name="email"><br><br>
                                        <label for="regular-form-2" class="form-label">Phone</label>
                                        <input id="regular-form-2" type="text" class="form-control form-control-rounded" placeholder="Enter Phone" name="phone"><br><br>
                                        <label for="regular-form-2" class="form-label">College</label>
                                        <input id="regular-form-2" type="text" class="form-control form-control-rounded" placeholder="Enter College" name="college"><br><br>
