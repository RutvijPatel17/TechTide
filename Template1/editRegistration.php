<?php
    ...
    $result = mysqli_query($conn, "select * from tbl_registration where Registration_ID=".$Registration_ID) or die(mysqli_error($conn));
    $row=mysqli_fetch_assoc($result);
    $name_value=$row["Student_ID"];
    $title_value=$row["Workshop_ID"];
    if (isset($_POST["btnsubmit"])){
        $wsname=$_POST["wsname"];
        $result = mysqli_query($conn,"UPDATE tbl_registration SET Workshop_ID='$wsname' WHERE Registration_ID='$Registration_ID';");
        //echo $result;die;
        if($result){
        echo "<script>
...
<html lang="en" class="light">
    ...
    <body class="py-5 md:py-0 bg-black/[0.15] dark:bg-transparent">
        ...
        <ol class="breadcrumb">
            <li class="breadcrumb-item"><a href="#">View Registration</a></li>
                            ...
                            <div id="input" class="p-5">
                                <div class="preview">
                                    <div class="mt-3">
                                        ...
                                        <select class="form-control form-control-rounded" aria-label="Default select example" name=stdname disabled>
                                        <?php
                                        ...
                                        <select class="form-control form-control-rounded" aria-label="Default select example" name=wsname selected=<?php echo $title_value;?>>
                                                <?php
