<?php
    ...
    if (isset($_POST["btnsubmit"])){
        ...
        $result = mysqli_query($conn,"insert into tbl_workshop(Title,Description,Date,Category,Workshop_img) 
        values('$title','$desc','$dateworkshop','$cat','$filename')") or die (mysqli_error($conn));
        //echo $result;die;
        if($result){
        echo "<script>
...
<html lang="en" class="light">
    ...
    <body class="py-5 md:py-0 bg-black/[0.15] dark:bg-transparent">
        ...
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active" aria-current="page">Add Workshop</li>
        </ol>
          </nav>
    <!-- BEGIN: Account Menu -->
                            ...
                            <div id="input" class="p-5">
                                <div class="preview">
                                    <div class="mt-3">
                                        ...
                                        <input id="regular-form-2" type="text" class="form-control form-control-rounded" placeholder="Enter Title" name="title"><br><br>
                                        <label for="regular-form-2" class="form-label">Description</label>
                                        <input id="regular-form-2" type="text" class="form-control form-control-rounded" placeholder="Enter Description" name="desc"><br><br>
                                        <label for="regular-form-2" class="form-label">Date</label>
                                        <input id="regular-form-2" type="date" class="form-control form-control-rounded" placeholder="Rounded" name="dateworkshop"><br><br>
                                        <label for="regular-form-2" class="form-label">Category</label>
                                        <div class="flex flex-col sm:flex-row items-center" name="cat">
                                        <select class="form-control form-control-rounded" aria-label="Default select example" name="cat" >
                                                <option value="Technical">Technical</option>
                                                <option value="Non-Technical">Non-Technical</option>
                                        </select>
                                        </div><br><br>
                                        <lable for="examplFormControlInput" class="form-lable">Upload Image</lable>
                                        <input type="file" class="form-control" id="Workshop_img" name="Workshop_img"><br>
                                        <div class="flex justify-center items-center v-screen"><br><br>
